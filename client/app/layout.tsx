...
export const metadata: Metadata = {
	...
	keywords: [
		...
		'factuur versturen',
		'BTW factuur',
		'invoicing software netherlands',
	...
	openGraph: {
		...
		description:
			"Maak professionele facturen, verstuur ze per e-mail en word sneller betaald. De factuurtools voor Nederlandse ZZP'ers.",
		type: 'website',
		locale: 'nl_NL',
		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: 'Factyo — Factureren voor ZZP',
			},
		],
	},
	twitter: {
		...
		title: 'Factyo — Online Factureren voor ZZP & Freelancers',
		description:
			'Maak professionele facturen, verstuur ze per e-mail en word sneller betaald.',
								...
								'@graph': [
									{
										...
										operatingSystem: 'Web',
										description:
											"Online facturensoftware voor ZZP'ers en freelancers in Nederland. Maak, verstuur en beheer BTW-facturen.",
										offers: [
											{
												'@type': 'Offer',
												name: 'Free',
											...
											},
											{
												...
												price: '7.95',
												priceCurrency: 'EUR',
												description: '10 facturen per maand',
											},
											{
												'@type': 'Offer',
												name: 'Unlimited',
												price: '12.50',
												priceCurrency: 'EUR',
												description: 'Onbeperkt facturen',
											},
										],
										aggregateRating: {
